          ...
          <div className="row align-items-start">
            <div className="col-md-7 py-5">
              ...
              <p className="text-muted">
                Transform your workforce with AvisTech IT Training & Placement's comprehensive corporate training programs.
              ...
              <p className="text-muted">
                At AvisTech, we focus on driving productivity, fostering innovation, and achieving measurable results. Partner
