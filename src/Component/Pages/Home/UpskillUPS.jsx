        ...
        <section className="py-5 bg-white" id="about">
            <div className="container">
                <div className="text-center mb-5">
                    <h2 className="display-5 fw-bold text-primary">Welcome to Upskill Institute</h2>
                </div>
                ...
                <div className="row align-items-center g-5">
                    ...
                    <div className="col-lg-6 col-12">
                        <p className="lead text-muted mb-4">
                            At Upskill Institute, we are dedicated to transforming individuals into skilled IT professionals
                            ready to excel in the dynamic world of technology. Our institute offers comprehensive training programs
                            and placement services designed to bridge the gap between academic knowledge and industry demands.
                        </p>
