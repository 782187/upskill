        ...
        <section className="py-5 bg-white" id="about">
            <div className="container">
                <div className="text-center mb-5">
                    <h2 className="display-5 fw-bold text-primary">Welcome to AvisTech</h2>
                </div>
                ...
                <div className="row align-items-center g-5">
                    ...
                    <div className="col-lg-6 col-12">
                        <p className="lead text-muted mb-4">
                            At AvisTech, we are dedicated to transforming individuals into skilled IT professionals and proficient web developers, ready to thrive in today's dynamic tech landscape. Our institute offers comprehensive training programs, real-world web development experience, and placement support — all designed to bridge the gap between academic learning and industry requirements.
                        </p>
