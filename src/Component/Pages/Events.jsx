      ...
      >
        <div className="position-absolute top-0 start-0 w-100 h-100 overflow-hidden">
          <video
            ...
            style={{ opacity: 1 }}
          >
            <source src="/upskillIntro.mp4" type="video/mp4" />
          </video>
          <div
        ...
        <div className="position-relative text-center container px-4">
          <h1
          ...
          >
            Celebrate knowledge, experience real-world industry, and grow with joy.
          </p>
        </div>
      </section>

      {/* Festival & Celebration Section */}
