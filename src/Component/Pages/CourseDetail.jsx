...
function CourseDetail() {
    ...
    useEffect(() => {
        axios.get(`https://upskill-servlet.onrender.com/upskill-servlet/get-course-detail?slug=${slug}`)
            .then(response => {
                    ...
                    <div className="row g-5 align-items-center">
                        <div className="col-md-6">
                            <div className="position-relative overflow-hidden rounded-4 shadow-sm">
                                <img 
                                    src={`https://upskill-servlet.onrender.com/upskill-servlet/get-image?courseId=${course.id}`} 
                                    alt={course.title}
            ...
            <section className="py-5 bg-light">
                <div className="container text-center">
                    ...
                    <div className="d-flex justify-content-center">
                        <img 
                            src={`https://upskill-servlet.onrender.com/upskill-servlet/get-certificate-image?courseId=${course.id}`} 
