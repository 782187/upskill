...
function CourseDetail() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8080/UpskillServlet/get-course-detail?slug=${slug}`)
            .then(response => {
                    ...
                    <div className="row g-5 align-items-center">
                        <div className="col-md-6">
                            <div className="position-relative overflow-hidden rounded-4 shadow-sm">
                                <img 
                                    src={`http://localhost:8080/UpskillServlet/get-image?courseId=${course.id}`} 
                                    alt={course.title}
            ...
            <section className="py-5 bg-light">
                <div className="container text-center">
                    ...
                    <div className="d-flex justify-content-center">
                        <img 
                            src={`http://localhost:8080/UpskillServlet/get-certificate-image?courseId=${course.id}`} 
